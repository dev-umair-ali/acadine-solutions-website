...
const caseStudies = [
  ...
  },
  {
    ...
    solution:
      'A founding team member brings more than two decades of biotechnology and life sciences systems development experience, including approximately seven years at Illumina and senior systems development leadership at Roche Sequencing Solutions, along with director level R&D experience at additional advanced biotechnology organizations and startups. Prior work contributed to multiple generations of next generation sequencing technology, including HiSeq, NextSeq, and MiSeqDx diagnostics platforms, as well as nanopore sequencing, digital cell biology platforms, and emerging single molecule proteomics technologies. The experience includes the development of machine learning algorithms and advanced AI systems for research and diagnostic applications.',
    approach: [
